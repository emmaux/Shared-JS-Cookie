          ...
          if (typeof(MktoForms2) === "undefined") {
              ...
              MktoForms2.onFormRender(function() {
                  ...
                  for (var i=0;i<signvarElements.length;i++) {
                      if (signvarElements[i] && !signvarElements[i].value) { // don't populate an already populated signupVar form value
                  ...
                  for (var i=0;i<last_ref_urls.length;i++) {
                      if (last_ref_urls[i] !== null)
                          last_ref_urls[i].value = encodeURIComponent(CDE_data.lastReferrerURL);
                  }
                  ...
                  for (var i=0;i<last_lp_urls.length;i++) {
                      if (last_lp_urls[i] !== null)
                          last_lp_urls[i].value = encodeURIComponent(CDE_data.lastLandingURL);
                  }
                  ...
                  for (var i=0;i<last_lpc_urls.length;i++) {
                      if (last_lpc_urls[i] != null)
                          last_lpc_urls[i].value = encodeURIComponent(CDE_data.lastLandingURL);
                  }
          ...
          var observer = new MutationObserver(function(mutations){
              for (var i=0; i < mutations.length; i++){
                  for (var j=0; j < mutations[i].addedNodes.length; j++){
                      if (typeof(mutations[i].addedNodes[j].matches) !== "undefined" && mutations[i].addedNodes[j].matches('form.mktoForm')){
